...
from kevin.machine_learning.patch_for_numpy.axis_and_dim.coordinates.generate._generate_z_pattern_indices_ls import \
    generate_z_pattern_indices_ls
from kevin.machine_learning.patch_for_numpy.axis_and_dim import coordinates

def stack_along_pattern(**kwargs):
    """
