...
from kevin.patches.for_torch import compatible
...
def test_concat():
    ...
    for _ in range(100):
        ...
        for ver in ["1.0", "1.12"]:
            ...
            importlib.reload(sys.modules["kevin.patches.for_torch.compatible.concat"])
...
def test_tile():
    ...
    for _ in range(100):
        ...
        for ver in ["1.0", "1.12"]:
            torch.__version__ = ver
            importlib.reload(sys.modules["kevin.patches.for_torch.compatible.tile"])
...
def test_where():
    ...
    for _ in range(100):
        ...
        for ver in ["1.0", "1.12"]:
            torch.__version__ = ver
            importlib.reload(sys.modules["kevin.patches.for_torch.compatible.where"])
