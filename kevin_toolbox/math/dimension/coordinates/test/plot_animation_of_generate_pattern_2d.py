...
from kevin_toolbox.patches.for_matplotlib import add_trajectory_2d, add_trajectory_3d
...
writer = animation.ImageMagickWriter(
    fps=2,
    metadata=dict(artist='hsu-kevin_toolbox: kevin_toolbox-toolbox', comment='contact me with: xukaiming1996@163.com')
)
